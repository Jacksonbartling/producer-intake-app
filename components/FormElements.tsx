...
export const CheckboxCard: React.FC<CheckboxItemProps> = ({ label, checked, onChange }) => (
  <button
    onClick={onChange}
      ...
      {selected.includes('Other') && onOtherChange && (
        <div className="animate-in fade-in slide-in-from-top-2 duration-300">
          <input
            ...
            className="w-full p-2 border-b-2 border-gray-200 focus:border-[#1B2E20] outline-none text-sm transition-all bg-transparent"
          />
        </div>
      )}
    </div>
